...
#paying off the guards

#1000ish most commen words
...
#how long till you get busted
livesLeft = 7
#Your atempts at the password
LettersGuessed = ''
#messy code:
#Defintions
def playHangMan():
    ...
    while True:
        guess = getGuess(word)
        if prosessingGuess(guess, word):
            hangman = ['_______\n|     @\n|    /|\\ \n|    / \\ \n|','_______\n|     O\n|    /|\\ \n|    / \\ \n|','_______\n|     O\n|    /|\\ \n|    /  \n|','_______\n|     O\n|    /|\\ \n|\n|','_______\n|     O\n|    /| \n|\n|','_______\n|     O\n|     |\n|\n|','_______\n|     O\n|\n|\n|','_______\n|\n|\n|\n|']
            print(hangman[livesLeft])
            print(word)
            print('You win!')
            break
        if livesLeft == 0:
...
def getGuess(word):
    hangman = ['_______\n|     @\n|    /|\\ \n|    / \\ \n|','_______\n|     O\n|    /|\\ \n|    / \\ \n|','_______\n|     O\n|    /|\\ \n|    /  \n|','_______\n|     O\n|    /|\\ \n|\n|','_______\n|     O\n|    /| \n|\n|','_______\n|     O\n|     |\n|\n|','_______\n|     O\n|\n|\n|','_______\n|\n|\n|\n|']
    print(hangman[livesLeft])
    print('Lives Remaining: ' + str(livesLeft))
    print('Letters Guessed:' + LettersGuessed)
    printWord(word)
    guess = input('Guess a letter or type the word:')
    return guess
...
def prosessingGuess(guess, word):
    if guess == word:
        return entireWordGuess(guess, word)
    else:
        return oneLetterGuessed(guess, word)

            
def entireWordGuess(guess, word):
    global livesLeft
...
def oneLetterGuessed(guess, word):
...
def fullWordGuess(word):
    for letter in word:
        if LettersGuessed.find(letter.lower()) == -1:
            return False
    return True
#using the past couple lines
playHangMan()
